...
<head>
    ...
    <link href="https://corestudi0.github.io/newyear/files/css/main.css" rel="stylesheet">
    <script src="https://corestudi0.github.io/newyear/files/js/jquery.min.js" type="text/javascript"></script>
    <script>
        var shouci = true;
        console.log(shouci);
...
<body>
    ...
    <div id="yhBtn" style="position:fixed;top:0;left:0;width:100%;height:100%;z-index:999;display:flex;flex-direction:column;justify-content:center;align-items:center;color:#fff ; font-size:20px    ">
        <p>💥新年快乐💥</p>
        <img style="width:64px;margin-bottom:36px " src="https://corestudi0.github.io/newyear/files/boom.png">
    </div>
...
<script>
    ...
    <div class="container">
        ...
        <div class="stage-container remove">
            <div class="page_two hide">
                <div id="text" style="display:none;"><p>今年<br><br>还有<span id="time"></span><br><span id="text1"></span><br>请你看烟花: 连击屏幕！<br><br>——xsj<br><span id="copyright"></span></p></div>
    ...
    <!-- partial -->
    <script src="https://corestudi0.github.io/newyear/files/js/fscreen%401.0.1.js"></script><!--!U+202C‏U+202CU+202BU+202DU+202BU+202BU+202CU+202BU+202DU+202BU+202CU+202C‏U+202DU+202DU+202A‏U+202C‎U+202BU+202C‎‎-->
    <script src="https://corestudi0.github.io/newyear/files/js/Stage%400.1.4.js"></script><!--!U+202C‏U+202CU+202BU+202DU+202BU+202BU+202CU+202BU+202DU+202BU+202CU+202C‏U+202DU+202DU+202A‏U+202C‎U+202BU+202C‎‎-->
    <script src="https://corestudi0.github.io/newyear/files/js/MyMath.js"></script><!--!U+202C‏U+202CU+202BU+202DU+202BU+202BU+202CU+202BU+202DU+202BU+202CU+202C‏U+202DU+202DU+202A‏U+202C‎U+202BU+202C‎‎-->
    <script src="https://corestudi0.github.io/newyear/files/js/script.js"></script><!--!U+202C‏U+202CU+202BU+202DU+202BU+202BU+202CU+202BU+202DU+202BU+202CU+202C‏U+202DU+202DU+202A‏U+202C‎U+202BU+202C‎‎-->
    ...
    </script><!--!U+202C‏U+202CU+202BU+202DU+202BU+202BU+202CU+202BU+202DU+202BU+202CU+202C‏U+202DU+202DU+202A‏U+202C‎U+202BU+202C‎‎-->
...
<script>
    ...
    var diff2Seconds = Math.floor((diff2 - (diff2Years * 365 + diff2Days) * days - diff2Hours * hours - diff2Minutes *
        minutes) / seconds)
     if(todayMonth==1){if(todayDate==1){document.getElementById("text1").innerHTML =  "祝罗卉云紫"+todayYear+"天天开心！"}}
